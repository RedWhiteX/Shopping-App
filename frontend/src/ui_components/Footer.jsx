      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-4 gap-6">
        <div>
          ...
          <p className="text-sm text-gray-300">
            Your go-to store for everything you love. Quality, simplicity, and
            ease.
          </p>
        </div>
        <div>
          ...
          <ul className="space-y-1 text-sm">
            ...
            <li>
              <a
                ...
                className="hover:underline flex items-center gap-2 transition-colors hover:text-pink-600"
            ...
            <li>
              <a
                ...
                className="hover:underline flex items-center gap-2 transition-colors hover:text-blue-600"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:underline flex items-center gap-2 transition-colors hover:text-green-600"
