...
//   "Pakistan": ["Karachi", "Lahore", "Faisalabad", "Rawalpindi", "Gujranwala", "Peshawar", "Multan", "Hyderabad", "Islamabad", "Quetta", "Bahawalpur", "Sargodha", "Sialkot", "Sukkur", "Larkana","Balochistan","hyderabad","Dir","BaBa Koda"],
...
//       // This is the same data structure you had before
//       const orderData = {
//         items: cart, // Send the whole cart
...
//         // Send the order data to your new backend endpoint
//         const response = await api.post('/orders/create/', orderData);

//         // Use the response from the backend
//         setOrderedItems(response.data.items || []); // Assuming the backend returns the items
...
//         setOrderStatus('cart'); // Reset status on failure
//       }
//     } else {
...
export default function Checkout() {
    ...
    const handleSubmitOrder = async (e) => {
        ...
        if (validateForm()) {
            ...
            const orderData = {
                items: cart,
                customerInfo: { ...formData, phone: `${selectedCountryCode}${formData.phone}` },
                total: cartTotal,
            };
